...
namespace UtmBuilder.Core.ValueObjects.Exceptions
{
    ...
    {
        private const string DefaultErrorMessaage = "Invalid URL";

        public InvalidUrlException(string message = DefaultErrorMessaage)
            : base(message)
        {
        }
        ...
        public static void ThrowIfInvalid(
            string address,
            string message = DefaultErrorMessaage)
        {
